...
import com.sample.test.adapter.QuestionListingAdapter
import com.sample.test.adapter.SpinnerAdapter
import com.sample.test.adapter.model.NetworkState
import com.sample.test.framework.presenter.MainPresenter
...
class MainFragment : BaseFragment(), MainView {
    ...
    private fun setupSpinner() {
        ...
        val spAdapter = SpinnerAdapter(context, categories)

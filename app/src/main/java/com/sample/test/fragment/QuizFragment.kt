...
import com.sample.test.adapter.SpinnerAdapter
import com.sample.test.extension.hide
import com.sample.test.extension.show
import com.sample.test.framework.model.QuizViewModel
import com.sample.test.framework.presenter.QuizPresenter
...
class QuizFragment : BaseFragment(), QuizView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        quizViewModel.answerMap.observe(this, Observer {
            ...
            tv_correct_count.text =
                getString(R.string.correct_answer_count, correctQuestion, quizViewModel.questionList.size)
        })
    ...
    fun initCategorySpinner() {
        ...
        categoryAdapter = SpinnerAdapter(context, list)
